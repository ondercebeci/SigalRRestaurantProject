...
namespace SignalR.BussinessLayer.ValidationRules.BookingValidations
{
    public class CreateBookingValidation:AbstractValidator<CreateBookingDto>
    {
        public CreateBookingValidation()
        {
            ...
            RuleFor(x => x.Name).MinimumLength(5).WithMessage("Lütfen isim alanına en az 5 karakter veri girişi yapınız.").MaximumLength(50).WithMessage("Lütfen isim alanına en fazla 50 karaketer veri girişi yapınız.");
            RuleFor(x => x.Description).MaximumLength(50).WithMessage("Lütfen Açıklama alanına en fazla 500 karaketer veri girişi yapınız.");
