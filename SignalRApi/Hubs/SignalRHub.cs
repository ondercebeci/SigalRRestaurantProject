...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public async Task SendStatistic()
        {
            ...
            await Clients.All.SendAsync("ReveiveProductCountByCategoryNameDrink", value6);

            var value7 = _productService.TProductAveragePrice();
            await Clients.All.SendAsync("ReveiveProductAveragePrice", value7.ToString("0.00") + "₺");
            ...
            var value10 = _productService.TProductAverageByHamburger();
            await Clients.All.SendAsync("ReceiveTProductAverageByHamburger", value10.ToString("0.00") + "₺");
        ...
        public async Task SendProgress()
        {
            ...
            var value5 = _productService.TProductAveragePrice();
			await Clients.All.SendAsync("ReceiveProductAveragePrice", value5);

              var value6 = _productService.TProductAverageByHamburger();
			await Clients.All.SendAsync("ReceiveProductAverageByHamburger", value6);
